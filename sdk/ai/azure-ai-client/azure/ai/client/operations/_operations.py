...
def build_evaluations_create_request(
    ...
    # Construct URL
    _url = "/raisvc/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/evaluations/create"  # pylint: disable=line-too-long
    path_format_arguments = {
...
def build_evaluations_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/raisvc/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/evaluations"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str"),
...
def build_evaluations_update_request(
    ...
    # Construct URL
    _url = "/raisvc/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/evaluations/{id}"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str"),
...
class EvaluationsOperations:
    ...
    def update(
        ...
        workspace_name: str,
        id: str,
        body: _models.UpdateEvaluationRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Evaluation:
    ...
    def update(
        ...
        workspace_name: str,
        id: str,
        body: Union[_models.UpdateEvaluationRequest, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.Evaluation:
        """Update an evaluation.
