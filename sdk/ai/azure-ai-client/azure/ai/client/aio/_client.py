...
class AzureAIClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :keyword endpoint: Azure AI Project endpoint. Default value is "https://management.azure.com".
    ...
    def __init__(
        self, credential: "AsyncTokenCredential", *, endpoint: str = "https://management.azure.com", **kwargs: Any
    ) -> None:
        _endpoint = "{endpoint}"
        self._config = AzureAIClientConfiguration(credential=credential, endpoint=endpoint, **kwargs)
